#ifndef _smirnov442_24_180_approx_HPP_
#define _smirnov442_24_180_approx_HPP_

// This is an automatically generated file from gen.py.
#include "common.hpp"

namespace smirnov442_24_180_approx {
...
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + j * strideC] = Scalar(1.0 / (x)) * dataM1[i + j * strideM1] -dataM2[i + j * strideM2] + Scalar(-(1.0 / (x))) * dataM3[i + j * strideM3] + Scalar(-(1.0 / (x))) * dataM4[i + j * strideM4] + Scalar(x) * dataM5[i + j * strideM5] + Scalar(1.0 / (x)) * dataM6[i + j * strideM6] + beta * dataC[i + j * strideC];
            }
        }
    } else {
#ifdef _PARALLEL_
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + j * strideC] = Scalar(1.0 / (x)) * dataM1[i + j * strideM1] -dataM2[i + j * strideM2] + Scalar(-(1.0 / (x))) * dataM3[i + j * strideM3] + Scalar(-(1.0 / (x))) * dataM4[i + j * strideM4] + Scalar(x) * dataM5[i + j * strideM5] + Scalar(1.0 / (x)) * dataM6[i + j * strideM6];
            }
        }
    }
}
...
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + j * strideC] = Scalar(x) * dataM1[i + j * strideM1] + Scalar(x) * dataM2[i + j * strideM2] -dataM3[i + j * strideM3] + Scalar(x) * dataM4[i + j * strideM4] + Scalar(x) * dataM5[i + j * strideM5] + Scalar(x * x) * dataM6[i + j * strideM6] + Scalar(x) * dataM7[i + j * strideM7] + Scalar(x) * dataM8[i + j * strideM8] + beta * dataC[i + j * strideC];
            }
        }
    } else {
#ifdef _PARALLEL_
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + j * strideC] = Scalar(x) * dataM1[i + j * strideM1] + Scalar(x) * dataM2[i + j * strideM2] -dataM3[i + j * strideM3] + Scalar(x) * dataM4[i + j * strideM4] + Scalar(x) * dataM5[i + j * strideM5] + Scalar(x * x) * dataM6[i + j * strideM6] + Scalar(x) * dataM7[i + j * strideM7] + Scalar(x) * dataM8[i + j * strideM8];
            }
        }
    }
}
...
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + j * strideC] = -dataM1[i + j * strideM1] -dataM2[i + j * strideM2] + Scalar(1.0 / (x)) * dataM3[i + j * strideM3] + Scalar(x) * dataM4[i + j * strideM4] -dataM5[i + j * strideM5] + dataM6[i + j * strideM6] + Scalar(1.0 / (x)) * dataM7[i + j * strideM7] + dataM8[i + j * strideM8] + Scalar(1.0 / (x)) * dataM9[i + j * strideM9] + beta * dataC[i + j * strideC];
            }
        }
    } else {
#ifdef _PARALLEL_
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + j * strideC] = -dataM1[i + j * strideM1] -dataM2[i + j * strideM2] + Scalar(1.0 / (x)) * dataM3[i + j * strideM3] + Scalar(x) * dataM4[i + j * strideM4] -dataM5[i + j * strideM5] + dataM6[i + j * strideM6] + Scalar(1.0 / (x)) * dataM7[i + j * strideM7] + dataM8[i + j * strideM8] + Scalar(1.0 / (x)) * dataM9[i + j * strideM9];
            }
        }
    }
}
...
template <typename Scalar>
void M_Add5(Matrix<Scalar>& M1, Matrix<Scalar>& M2, Matrix<Scalar>& M3, Matrix<Scalar>& M4, Matrix<Scalar>& M5, Matrix<Scalar>& M6, Matrix<Scalar>& M7, Matrix<Scalar>& M8, Matrix<Scalar>& C, double x, bool sequential, Scalar beta) {
    const int strideM1 = M1.stride();
    const int strideM2 = M2.stride();
    const int strideM3 = M3.stride();
    const int strideM4 = M4.stride();
...
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + j * strideC] = dataM1[i + j * strideM1] + Scalar(1.0 / (x)) * dataM2[i + j * strideM2] + Scalar(1.0 / (x)) * dataM3[i + j * strideM3] + Scalar(1.0 / (x)) * dataM4[i + j * strideM4] + Scalar(1.0 / (x)) * dataM5[i + j * strideM5] -dataM6[i + j * strideM6] + beta * dataC[i + j * strideC];
            }
        }
    } else {
#ifdef _PARALLEL_
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + j * strideC] = dataM1[i + j * strideM1] + Scalar(1.0 / (x)) * dataM2[i + j * strideM2] + Scalar(1.0 / (x)) * dataM3[i + j * strideM3] + Scalar(1.0 / (x)) * dataM4[i + j * strideM4] + Scalar(1.0 / (x)) * dataM5[i + j * strideM5] -dataM6[i + j * strideM6];
            }
        }
    }
}
...
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + j * strideC] = dataM1[i + j * strideM1] + Scalar(x) * dataM2[i + j * strideM2] + dataM3[i + j * strideM3] + dataM4[i + j * strideM4] + beta * dataC[i + j * strideC];
            }
        }
    } else {
#ifdef _PARALLEL_
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + j * strideC] = dataM1[i + j * strideM1] + Scalar(x) * dataM2[i + j * strideM2] + dataM3[i + j * strideM3] + dataM4[i + j * strideM4];
            }
        }
    }
}
...
template <typename Scalar>
void M_Add8(Matrix<Scalar>& M1, Matrix<Scalar>& M2, Matrix<Scalar>& M3, Matrix<Scalar>& M4, Matrix<Scalar>& M5, Matrix<Scalar>& M6, Matrix<Scalar>& M7, Matrix<Scalar>& M8, Matrix<Scalar>& M9, Matrix<Scalar>& M10, Matrix<Scalar>& C, double x, bool sequential, Scalar beta) {
    const int strideM1 = M1.stride();
    const int strideM2 = M2.stride();
    const int strideM3 = M3.stride();
    const int strideM4 = M4.stride();
...
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + j * strideC] = Scalar(-(x)) * dataM1[i + j * strideM1] + Scalar(-(x)) * dataM2[i + j * strideM2] + Scalar(x) * dataM3[i + j * strideM3] + Scalar(x * x) * dataM4[i + j * strideM4] + Scalar(x) * dataM5[i + j * strideM5] + Scalar(x) * dataM6[i + j * strideM6] + Scalar(x) * dataM7[i + j * strideM7] + Scalar(x) * dataM8[i + j * strideM8] + Scalar(x) * dataM9[i + j * strideM9] + Scalar(x) * dataM10[i + j * strideM10] + beta * dataC[i + j * strideC];
            }
        }
    } else {
#ifdef _PARALLEL_
# pragma omp parallel for if(!sequential)
        ...
        for (int j = 0; j < C.n(); ++j) {
            for (int i = 0; i < C.m(); ++i) {
                dataC[i + j * strideC] = Scalar(-(x)) * dataM1[i + j * strideM1] + Scalar(-(x)) * dataM2[i + j * strideM2] + Scalar(x) * dataM3[i + j * strideM3] + Scalar(x * x) * dataM4[i + j * strideM4] + Scalar(x) * dataM5[i + j * strideM5] + Scalar(x) * dataM6[i + j * strideM6] + Scalar(x) * dataM7[i + j * strideM7] + Scalar(x) * dataM8[i + j * strideM8] + Scalar(x) * dataM9[i + j * strideM9] + Scalar(x) * dataM10[i + j * strideM10];
            }
        }
    }
}
...
# pragma omp task if(sequential1) shared(mem_mngr, locker) untied default(shared)
    ...
    FastMatmulRecursive(locker, mem_mngr, S1, T1, M1, total_steps, steps_left - 1, (start_index + 1 - 1) * 24, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    S1.deallocate();
    T1.deallocate();
#endif
...
# pragma omp task if(sequential2) shared(mem_mngr, locker) untied default(shared)
    ...
    FastMatmulRecursive(locker, mem_mngr, S2, T2, M2, total_steps, steps_left - 1, (start_index + 2 - 1) * 24, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    S2.deallocate();
    T2.deallocate();
#endif
...
# pragma omp task if(sequential3) shared(mem_mngr, locker) untied default(shared)
    ...
    FastMatmulRecursive(locker, mem_mngr, S3, T3, M3, total_steps, steps_left - 1, (start_index + 3 - 1) * 24, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    S3.deallocate();
    T3.deallocate();
#endif
...
# pragma omp task if(sequential4) shared(mem_mngr, locker) untied default(shared)
    ...
    FastMatmulRecursive(locker, mem_mngr, S4, T4, M4, total_steps, steps_left - 1, (start_index + 4 - 1) * 24, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    S4.deallocate();
    T4.deallocate();
#endif
...
# pragma omp task if(sequential5) shared(mem_mngr, locker) untied default(shared)
    ...
    FastMatmulRecursive(locker, mem_mngr, S5, T5, M5, total_steps, steps_left - 1, (start_index + 5 - 1) * 24, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    S5.deallocate();
    T5.deallocate();
#endif
...
# pragma omp task if(sequential6) shared(mem_mngr, locker) untied default(shared)
    ...
    FastMatmulRecursive(locker, mem_mngr, S6, T6, M6, total_steps, steps_left - 1, (start_index + 6 - 1) * 24, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    S6.deallocate();
    T6.deallocate();
#endif
...
# pragma omp task if(sequential7) shared(mem_mngr, locker) untied default(shared)
    ...
    FastMatmulRecursive(locker, mem_mngr, S7, T7, M7, total_steps, steps_left - 1, (start_index + 7 - 1) * 24, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    S7.deallocate();
    T7.deallocate();
#endif
...
# pragma omp task if(sequential8) shared(mem_mngr, locker) untied default(shared)
    ...
    FastMatmulRecursive(locker, mem_mngr, S8, T8, M8, total_steps, steps_left - 1, (start_index + 8 - 1) * 24, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    S8.deallocate();
    T8.deallocate();
#endif
...
# pragma omp task if(sequential9) shared(mem_mngr, locker) untied default(shared)
    ...
    FastMatmulRecursive(locker, mem_mngr, S9, T9, M9, total_steps, steps_left - 1, (start_index + 9 - 1) * 24, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    S9.deallocate();
    T9.deallocate();
#endif
...
# pragma omp task if(sequential10) shared(mem_mngr, locker) untied default(shared)
    ...
    FastMatmulRecursive(locker, mem_mngr, S10, T10, M10, total_steps, steps_left - 1, (start_index + 10 - 1) * 24, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    S10.deallocate();
    T10.deallocate();
#endif
...
# pragma omp task if(sequential11) shared(mem_mngr, locker) untied default(shared)
    ...
    FastMatmulRecursive(locker, mem_mngr, S11, T11, M11, total_steps, steps_left - 1, (start_index + 11 - 1) * 24, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    S11.deallocate();
    T11.deallocate();
#endif
...
# pragma omp task if(sequential12) shared(mem_mngr, locker) untied default(shared)
    ...
    FastMatmulRecursive(locker, mem_mngr, A43, T12, M12, total_steps, steps_left - 1, (start_index + 12 - 1) * 24, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    T12.deallocate();
#endif
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# pragma omp task if(sequential13) shared(mem_mngr, locker) untied default(shared)
    ...
    FastMatmulRecursive(locker, mem_mngr, S13, B12, M13, total_steps, steps_left - 1, (start_index + 13 - 1) * 24, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    S13.deallocate();
#endif
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# pragma omp task if(sequential14) shared(mem_mngr, locker) untied default(shared)
    ...
    FastMatmulRecursive(locker, mem_mngr, S14, B11, M14, total_steps, steps_left - 1, (start_index + 14 - 1) * 24, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    S14.deallocate();
#endif
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# pragma omp task if(sequential15) shared(mem_mngr, locker) untied default(shared)
    ...
    FastMatmulRecursive(locker, mem_mngr, S15, B21, M15, total_steps, steps_left - 1, (start_index + 15 - 1) * 24, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    S15.deallocate();
#endif
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# pragma omp task if(sequential16) shared(mem_mngr, locker) untied default(shared)
    ...
    FastMatmulRecursive(locker, mem_mngr, S16, T16, M16, total_steps, steps_left - 1, (start_index + 16 - 1) * 24, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    S16.deallocate();
    T16.deallocate();
#endif
...
# pragma omp task if(sequential17) shared(mem_mngr, locker) untied default(shared)
    ...
    FastMatmulRecursive(locker, mem_mngr, A13, T17, M17, total_steps, steps_left - 1, (start_index + 17 - 1) * 24, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    T17.deallocate();
#endif
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# pragma omp task if(sequential18) shared(mem_mngr, locker) untied default(shared)
    ...
    FastMatmulRecursive(locker, mem_mngr, S18, T18, M18, total_steps, steps_left - 1, (start_index + 18 - 1) * 24, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    S18.deallocate();
    T18.deallocate();
#endif
...
# pragma omp task if(sequential19) shared(mem_mngr, locker) untied default(shared)
    ...
    FastMatmulRecursive(locker, mem_mngr, S19, T19, M19, total_steps, steps_left - 1, (start_index + 19 - 1) * 24, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    S19.deallocate();
    T19.deallocate();
#endif
...
# pragma omp task if(sequential20) shared(mem_mngr, locker) untied default(shared)
    ...
    FastMatmulRecursive(locker, mem_mngr, A33, T20, M20, total_steps, steps_left - 1, (start_index + 20 - 1) * 24, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    T20.deallocate();
#endif
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# pragma omp task if(sequential21) shared(mem_mngr, locker) untied default(shared)
    ...
    FastMatmulRecursive(locker, mem_mngr, A44, T21, M21, total_steps, steps_left - 1, (start_index + 21 - 1) * 24, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    T21.deallocate();
#endif
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# pragma omp task if(sequential22) shared(mem_mngr, locker) untied default(shared)
    ...
    FastMatmulRecursive(locker, mem_mngr, S22, B22, M22, total_steps, steps_left - 1, (start_index + 22 - 1) * 24, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    S22.deallocate();
#endif
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# pragma omp task if(sequential23) shared(mem_mngr, locker) untied default(shared)
    ...
    FastMatmulRecursive(locker, mem_mngr, A42, T23, M23, total_steps, steps_left - 1, (start_index + 23 - 1) * 24, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    T23.deallocate();
#endif
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# pragma omp task if(sequential24) shared(mem_mngr, locker) untied default(shared)
    ...
    FastMatmulRecursive(locker, mem_mngr, S24, B42, M24, total_steps, steps_left - 1, (start_index + 24 - 1) * 24, x, num_threads, Scalar(0.0));
#ifndef _PARALLEL_
    S24.deallocate();
#endif
#if defined(_PARALLEL_) && (_PARALLEL_ == _BFS_PAR_ || _PARALLEL_ == _HYBRID_PAR_)
...
# pragma omp taskwait
    ...
    M_Add1(M3, M4, M6, M10, M21, M24, C11, x, false, beta);
    M_Add2(M3, M4, M5, M7, M8, M10, M17, M24, C12, x, false, beta);
    M_Add3(M2, M8, M9, M15, M18, M21, M22, M23, C21, x, false, beta);
    M_Add4(M1, M2, M5, M6, M8, M9, M11, M12, M18, C22, x, false, beta);
    M_Add5(M1, M2, M4, M7, M13, M14, M19, M20, C31, x, false, beta);
    M_Add6(M3, M9, M12, M16, M17, M20, C32, x, false, beta);
    M_Add7(M2, M14, M15, M21, C41, x, false, beta);
    M_Add8(M1, M2, M4, M6, M7, M9, M12, M13, M20, M23, C42, x, false, beta);
...
#ifdef _PARALLEL_
    mem_mngr.Allocate(4, 4, 2, 24, num_steps, A.m(), A.n(), B.n());
#endif
...
#endif  // _smirnov442_24_180_approx_HPP_
